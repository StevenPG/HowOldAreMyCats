...
export class ContentComponent implements OnInit {
  ...
  bucketName = "Bucket"
  bucketNickname = "Buxter Brown, Bucky, Wings, Buckaroo"
  ...
  bonesName = "Bones"
  bonesNickname = "Boone, Booner, Chicken Bone"
  ...
  wobblesName = "Wobbles"
  wobblesNickname = "Weebs, wobbs, Weebledy Wobbldy Woo"
  ...
  wobblesImageSrc = "https://i.imgur.com/Ya8YW1P.jpg"
